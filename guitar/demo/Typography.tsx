...
export function Typography() {
	return (
		<>
			...
			<p>"<b>The Raven</b>" is a <a href="/wiki/Narrative_poem" className="mw-redirect" title="Narrative poem">narrative poem</a> by American writer <a
				href="/wiki/Edgar_Allan_Poe" title="Edgar Allan Poe">Edgar Allan Poe</a>. First published in January 1845, the poem is often noted for its
				musicality, stylized language and <a href="/wiki/Supernatural" title="Supernatural">supernatural</a> atmosphere. It tells of a distraught lover
				...
				single word. The lover, often identified as a student, is lamenting the loss of his love, Lenore. Sitting on a <a href="/wiki/Bust_(sculpture)"
																																  title="Bust (sculpture)">bust</a> of <a
					href="/wiki/Athena#Pallas_Athena" title="Athena">Pallas</a>, the raven seems to antagonize the protagonist further with its repetition of
				the word "<a href="https://en.wiktionary.org/wiki/nevermore" className="extiw" title="wikt:nevermore">nevermore</a>". The poem makes use of <a
			...
			<p>Poe stated that he composed the poem in a logical and methodical manner, aiming to craft a piece that would resonate with both critical and
				popular audiences, as he elaborated in his follow-up essay in 1846, "<a href="/wiki/The_Philosophy_of_Composition"
																						title="The Philosophy of Composition">The Philosophy of Composition</a>".
				...
				complex rhythm and <a href="/wiki/Meter_(poetry)" className="mw-redirect" title="Meter (poetry)">meter</a> on <a href="/wiki/Elizabeth_Barrett"
																																 className="mw-redirect"
																																 title="Elizabeth Barrett">Elizabeth
					Barrett</a>'s poem "Lady Geraldine's Courtship" and made use of <a href="/wiki/Internal_rhyme" title="Internal rhyme">internal rhyme</a> as
			...
			<p>"The Raven" was first attributed to Poe in print in the <i><a href="/wiki/New_York_Evening_Mirror" className="mw-redirect"
				...
				1845. Its publication made Poe popular in his lifetime, although it did not bring him much financial success. The poem was soon reprinted, <a
					href="/wiki/Parodied" className="mw-redirect" title="Parodied">parodied</a>, and illustrated. Critical opinion is divided as to the poem's
			...
			<p>Poe wrote the poem as a narrative, without intentional <a href="/wiki/Allegory" title="Allegory">allegory</a> or <a href="/wiki/Didacticism"
				...
				The main theme of the poem is one of undying devotion. The narrator experiences a <a
					href="/wiki/The_Imp_of_the_Perverse" title="The Imp of the Perverse">perverse conflict</a> between desire to forget and desire to remember.
				He
				...
				whether the raven actually knows what it is saying or whether it really intends to cause a reaction in the poem's narrator. The narrator begins
				as "weak
				...
				suggests the poem is a type of <a href="/wiki/Elegiac" title="Elegiac">elegiac</a> <a href="/wiki/Paraclausithyron" className="mw-redirect"
																									  title="Paraclausithyron">paraclausithyron</a>, an ancient
